...
public abstract partial class MemberInfo
{
    ...
    /// </summary>
    /// <returns><see langword="true"/> if the <see cref="MemberInfo"/> is part of an assembly held in a collectible assembly load context; otherwise, <see langword="false"/>.</returns>
